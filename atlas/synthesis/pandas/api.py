...
def gen_df_index(inputs, *args, **kwargs):
    _self = SelectInput(inputs, dtype=pd.DataFrame, extra_kwargs=kwargs)
...
def gen_df_isna(inputs, *args, **kwargs):
    ...
    _self = SelectInput(inputs, dtype=pd.DataFrame, label="input_df_isna_notna", extra_kwargs=kwargs)
...
def gen_df_isin(inputs, output, *args, **kwargs):
    ...
    _values = SelectInput(inputs, dtype=(list, tuple, pd.Series, dict, pd.DataFrame), context=c, label="values_df_isin", extra_kwargs=kwargs)
...
def gen_df_where(inputs, *args, **kwargs):
    ...
    _other = SelectInput(inputs, dtype=(typing.Sequence, pd.DataFrame, Callable), extra_kwargs=kwargs)
...
def gen_df_query(inputs, *args, **kwargs):
    ...
    _self = SelectInput(inputs, dtype=pd.DataFrame, extra_kwargs=kwargs)
    _expr = SelectInput(inputs, dtype=str, extra_kwargs=kwargs)
...
def gen_df_combine(inputs, *args, **kwargs):
    ...
    _self = SelectInput(inputs, dtype=pd.DataFrame, extra_kwargs=kwargs)
    _other = SelectInput(inputs, dtype=pd.DataFrame, extra_kwargs=kwargs)
    _func = SelectInput(inputs, dtype=Callable, extra_kwargs=kwargs)
...
def gen_df_agg(inputs, *args, **kwargs):
    ...
    _self = SelectInput(inputs, dtype=pd.DataFrame, extra_kwargs=kwargs)
    _func = SelectInput(inputs, dtype=(str, dict, list, tuple, Callable), extra_kwargs=kwargs)
    _axis = Select([0, 1], fixed_domain=True)
...
def gen_df_add_prefix(inputs, *args, **kwargs):
    ...
    _self = SelectInput(inputs, dtype=pd.DataFrame, extra_kwargs=kwargs)
    _prefix = SelectInput(inputs, dtype=str, extra_kwargs=kwargs)
...
def gen_df_add_suffix(inputs, *args, **kwargs):
    ...
    _self = SelectInput(inputs, dtype=pd.DataFrame, extra_kwargs=kwargs)
    _suffix = SelectInput(inputs, dtype=str, extra_kwargs=kwargs)
...
def gen_df_align(inputs, *args, **kwargs):
    ...
    _self = SelectInput(inputs, dtype=pd.DataFrame, extra_kwargs=kwargs)
    _other = SelectInput(inputs, dtype=(pd.DataFrame, pd.Series), extra_kwargs=kwargs)
...
def gen_df_filter(inputs, *args, **kwargs):
    ...
    if mode == 'use_items':
        ...
        _axis = Select([0, 1], fixed_domain=True)
        _like = SelectInput(inputs, dtype=str, extra_kwargs=kwargs)
        ...
        _axis = Select([0, 1], fixed_domain=True)
        _regex = SelectInput(inputs, dtype=str, extra_kwargs=kwargs)
...
def gen_df_rename(inputs, *args, **kwargs):
    ...
    if use_index_columns:
        _index = SelectInput(inputs, dtype=(dict, Callable), extra_kwargs=kwargs)
        _columns = SelectInput(inputs, dtype=(dict, Callable), extra_kwargs=kwargs)
        ...
        _axis = Select([0, 1], fixed_domain=True)
        _mapper = SelectInput(inputs, dtype=(dict, Callable), extra_kwargs=kwargs)
        src = _self.index if _axis == 0 else _self.columns
        if src.nlevels == 1:
            _level = None
        else:
...
def gen_df_take(inputs, *args, **kwargs):
    ...
    _self = SelectInput(inputs, dtype=pd.DataFrame, extra_kwargs=kwargs)
    _indices = SelectInput(inputs, dtype=typing.Sequence, extra_kwargs=kwargs)
    _axis = Select([0, 1], fixed_domain=True)
...
def gen_df_merge(inputs, *args, **kwargs):
    ...
    _self = SelectInput(inputs, dtype=pd.DataFrame, extra_kwargs=kwargs)
    _right = SelectInput(inputs, dtype=pd.DataFrame, extra_kwargs=kwargs)
...
def gen_dfgroupby_count(inputs, *args, **kwargs):
    ...
    _self = SelectInput(inputs, dtype=pd_dfgroupby, extra_kwargs=kwargs)
    return _self.count(), {
        'self': _self
    }
...
class PandasDataGenerationStrategy(DfsStrategy):
    ...
    def select_input_with_new_input(self, domain, dtype, new_val, extra_kwargs: Dict):
        ...
        #  corresponding to this SelectInput call.
    ...
    @operator
    def SelectInput(self, domain, dtype=None, extra_kwargs: Dict = None, **kwargs):
    ...
    def SelectInput_input_df_isna_notna(self, domain, extra_kwargs: Dict = None, **kwargs):
        yield from self.select_input_for_dataframe(domain, DfConfig(nan_prob=0.5), extra_kwargs)

    def SelectInput_values_df_isin(self, domain, dtype=None, context=None, extra_kwargs: Dict = None, **kwargs):
